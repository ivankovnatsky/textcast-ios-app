...
BUNDLE_ID = ivankovnatsky.TextCastApp
...
APP_PATH = $(shell find $(HOME)/Library/Developer/Xcode/DerivedData -name "TextCastApp.app" -path "*/Debug-iphonesimulator/*" 2>/dev/null | head -1)
